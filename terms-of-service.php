...
<html lang="en">
  <head>
    ...
    <title>Picanxa | Terms of Service</title>
    <link rel="stylesheet" href="style.css" type="text/css" />
    <link
      href="https://fonts.googleapis.com/css2?family=Roboto+Slab:wght@100;300;400;500&display=swap"
      rel="stylesheet"
    />
  ...
  <body>
    ...
    <div class="policy-box">
      <h2 class="other-font">TERMS OF SERVICE</h2>
      <h5>OVERVIEW</h5>
      <p>
        This website is operated by Picanxa Sauce. Throughout the site, the
        terms “we”, “us” and “our” refer to Picanxa Sauce. Picanxa Sauce offers
      ...
      <p>
        In no case shall Picanxa Sauce, our directors, officers, employees,
      ...
      <p>
        You agree to indemnify, defend and hold harmless Picanxa Sauce and our
      ...
      <p>
        ...
        <a href="mailto:PicanxaSauce@gmail.com" class="policy-box-link"
          >PicanxaSauce@gmail.com</a
        >.
      </p>
    </div>
    ...
    <footer class="footer">
      ...
      <div class="footer-links">
        <a href="/refund-policy.php" class="footer-link"><h5>REFUND POLICY</h5> </a>
